    ...
    <div className='container mx-auto font-pop py-6'>
      <div className='flex flex-col md:flex-row gap-6'>
        ...
        <div className='space-y-4 py-4 px-4 w-full md:grow'>
          <p className='text-3xl text-slate-700 font-extrabold capitalize'>
            {name}
          </p>
          <div className='flex justify-start items-center'>
            ...
            <StarIcon className='h-7 w-7 text-yellow-400' />
            <StarIcon className='h-7 w-7 text-yellow-400' />
            <StarIcon className='h-7 w-7 text-yellow-400' />({20})
          </div>
          <hr />
          <div className='mt-4'>
          ...
          <div className='flex gap-4 justify-center items-center bg-gray-200 rounded-full md:w-1/2'>
            <span
              className='px-3 py-4 cursor-pointer text-2xl text-center block  rounded-md'
              onClick={decQty}
            >
              -
            </span>{' '}
      ...
      <div className='space-y-4 mt-4 px-4'>
        <h1 className='text-3xl text-slate-700 font-extrabold capitalize'>
         You may also like 
        </h1>
        <hr />
