          ...
          <div>
            <ul className='inline-flex items-center space-x-4'>
              <li className='text-xl md:text-3xl text-gray-500'>
                <Link href={'/profile'}>EditProfile</Link>
              </li>
            ...
            <div className='w-full md:w-1/2'>
              ...
              <div className='space-y-4 mb-4'>
                <div className='flex justify-center items-center space-x-3'>
                  <input
                    type='text'
                    className='w-full rounded-md border-gray-300 outline-none  focus:border-emerald-500 ring-1 ring-emerald-100 focus:ring-4 focus:ring-emerald-300'
                    value={firstname}
                ...
                <div className='group'>
                  <input
                    type='text'
                    className='w-full py-8 rounded-md border-gray-300 outline-none  focus:border-emerald-500 ring-1 ring-emerald-100 focus:ring-4 focus:ring-emerald-300'
                    value={address}
