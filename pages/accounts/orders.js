          ...
          {products.map((item) => (
            ...
            >
              ...
              <div className='py-2'>
                ...
                <div className='flex md:flex-wrap justify-center items-start gap-4'>
                  <Link href=''>
                  ...
                  <Link href=''>
                    <p className='border border-1 border-emerald-500 px-3 py-2.5 text-emerald-500 rounded-full w-full text-center'>
                      View item Details
                    </p>
                  </Link>
                </div>
